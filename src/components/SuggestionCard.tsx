  ...
  return (
    <article className={`rounded-xl border p-4 ${approved ? 'border-green-500 bg-green-50' : 'border-slate-200 bg-white'}`}>
      <div className="mb-2 flex items-center justify-between gap-3">
        <h4 className="font-semibold text-slate-900">{toneLabels[suggestion.tone]}</h4>
        {approved && <span className="text-xs font-medium text-green-700">Đã duyệt</span>}
      </div>
